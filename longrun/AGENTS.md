...
- Design: dark graphite background, bone text, one amber accent (`--accent`), Instrument Serif display + Inter Tight body + JetBrains Mono labels, left-aligned editorial grid. Keep it distinct from Idler (light, centered, multicolor).
